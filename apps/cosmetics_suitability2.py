...
layout = html.Div(
    [
        ...
        html.H2(
            'After it, little people inside the machine are rushing to find out whether the product is suitable for you:)',
            style={
                'margin-left': '25px',
                'margin-right': '25px',
                'color': '#1A3E5C',
        ...
        html.H2(
            "Here is a picture that can help you determine the skin type. If anyway you cannot do it, please select 'Not sure' option\n",
            style={
                'color': '#1A3E5C',
                'margin': '15px',
                'margin-left': '25px',
